                            ...
                            if unique_track_key not in self.processed_track_ids:
                                ...
                                def _async_anpr_task(a_crop, a_raw_frame, a_obj_id, a_trigger_name, a_box):
                                    ...
                                    a_save_data = {
                                        ...
                                        "image_plate_url": a_local_plate_path or a_r2_plate_url,
                                        "image_object_url": a_local_object_path or a_r2_object_url,
                ...
                for box, obj_id, conf in zip(boxes, ids, confs):
                    ...
                    if unique_track_key not in processed_track_ids:
                        ...
                        save_data = {
                            ...
                            "image_plate_url": local_plate_path or r2_plate_url,
                            "image_object_url": local_object_path or r2_object_url,
